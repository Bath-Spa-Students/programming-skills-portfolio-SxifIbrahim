...
# Create a list of people to invite to dinner and the messages
invitees = [
...
new_invitee = {"name": "Joshua Gofulco", "message": "Dear Gofulco, your groundbreaking work in the field of radiology and your contributions to science..."}
